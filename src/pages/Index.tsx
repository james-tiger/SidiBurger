...
// Define HeroSection outside RestaurantMenu for better organization
const HeroSection = () => (
...
const RestaurantMenu = () => {
  ...
  const menuData = {
    appetizers: {
      ...
      titleEn: "APPETIZERS",
      items: [
        { name: "بيكون", nameEn: "Bacon", price: "25", description: "شرائح لحم مقدد" },
        ...
        { name: "مشروم", nameEn: "Mushroom", price: "25", description: "مشروم طازج" },
        { name: "هالبينو", nameEn: "Jalapeño", price: "10", description: "فلفل هالبينو حار" },
        { name: "صوص جبنة", nameEn: "Cheese Sauce", price: "15", description: "صوص جبنة كريمي" },
        { name: "بسطرمة", nameEn: "Pastrami", price: "25", description: "شرائح بسطرمة مدخنة" },
        { name: "قطعة برجر راقي", nameEn: "Premium Burger Patty", price: "35", description: "قطعة برجر عالية الجودة" },
        { name: "قطعة برجر متشبك", nameEn: "Linked Burger Patty", price: "65", description: "قطعة برجر مميزة" },
      ],
    },
    sauces: {
      title: "الصوصات",
      titleEn: "SAUCES",
      items: [
        { name: "كلاسيك صوص", nameEn: "Classic Sauce", price: "15", description: "صوص كلاسيكي مميز" },
        { name: "إسباني صوص", nameEn: "Spanish Sauce", price: "15", description: "صوص بنكهة إسبانية" },
        { name: "سيدي صوص", nameEn: "Sidi Sauce", price: "25", description: "صوص سيدي الخاص" },
        { name: "صوص جبنة", nameEn: "Cheese Sauce", price: "25", description: "صوص جبنة كريمي" },
        { name: "صوص أعشاب", nameEn: "Herb Sauce", price: "20", description: "صوص بالأعشاب الطازجة" },
      ],
    },
    sides: {
      title: "أصناف جانبية",
      titleEn: "SIDES",
      items: [
        { name: "عدد ٢ قطع ستربس", nameEn: "2 Pieces Strips", price: "70", description: "قطعتان من الدجاج المقرمش" },
        { name: "تشيز ميل فرايز", nameEn: "Cheese Meal Fries", price: "70", description: "بطاطس مقلية مع صوص الجبنة" },
        { name: "سدق تشيز فرايز", nameEn: "Sidi Cheese Fries", price: "80", description: "بطاطس مقلية مع صوص سيدي" },
        { name: "تشيز سيدي فرايز", nameEn: "Sidi Cheese Fries", price: "95", description: "بطاطس مقلية مع صوص جبنة مميز" },
        { name: "باكيت بطاطس", nameEn: "Fries Packet", price: "30", description: "بطاطس مقلية طازجة" },
      ],
    },
    chicken: {
      title: "منيو السدق",
      ...
      items: [
        { name: "كلاسيك سدق", nameEn: "Classic Chicken", price: "135", description: "سدق + خس + طماطم + بصل + خيار مخلل + صوص جبنة + صوص كلاسيك" },
        { name: "دراجون هيل سدق", nameEn: "Dragon Hill Chicken", price: "138", description: "سدق + خس + طماطم + بصل + خيار مخلل + هالبينو + اسبايسي صوص" },
        { name: "مشروم سدق", nameEn: "Mushroom Chicken", price: "140", description: "سدق + خس + طماطم + بصل + مشروم كريمي + خيار مخلل" },
        { name: "سكول أرت سدق", nameEn: "Soul Art Chicken", price: "155", description: "سدق + خس + طماطم + بصل + بسطرمة + بيكون + سيدي صوص" },
        { name: "تريبول وي سدق", nameEn: "Triple Way Chicken", price: "140", description: "سدق + خس + طماطم + بصل مكرمل + سيدي صوص" },
      ],
    },
    meat: {
      title: "منيو اللحم",
      ...
      categories: [
        {
          ...
          nameEn: "Regular",
          items: [
            { name: "كلاسيك تشيز بيف", nameEn: "Classic Cheese Beef", price: "159", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + خيار مخلل + صوص جبنة + صوص كلاسيك" },
            { name: "دراجون هيل", nameEn: "Dragon Hill", price: "159", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + خيار مخلل + هالبينو + اسبايسي صوص" },
            { name: "مشروم برجر", nameEn: "Mushroom Burger", price: "165", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + مشروم كريمي + خيار مخلل" },
            { name: "سكول أرت", nameEn: "School Art", price: "179", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + بسطرمة + بيكون + سيدي صوص" },
            { name: "تريبل وي", nameEn: "Triple Way", price: "195", description: "قطعة لحم بقري صافي + خس + طماطم + بصل مكرمل + سيدي صوص" },
          ],
        },
        {
          ...
          nameEn: "Combo",
          items: [
            { name: "كلاسيك تشيز بيف + بطاطس", nameEn: "Classic Cheese Beef + Fries", price: "189", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + خيار مخلل + صوص جبنة + صوص كلاسيك + بطاطس" },
            { name: "دراجون هيل + بطاطس", nameEn: "Dragon Hill + Fries", price: "189", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + خيار مخلل + هالبينو + اسبايسي صوص + بطاطس" },
            { name: "مشروم برجر + بطاطس", nameEn: "Mushroom Burger + Fries", price: "199", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + مشروم كريمي + خيار مخلل + بطاطس" },
            { name: "سكول أرت + بطاطس", nameEn: "School Art + Fries", price: "209", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + بسطرمة + بيكون + سيدي صوص + بطاطس" },
            { name: "تريبل وي + بطاطس", nameEn: "Triple Way + Fries", price: "225", description: "قطعة لحم بقري صافي + خس + طماطم + بصل مكرمل + سيدي صوص + بطاطس" },
          ],
        },
      ],
    },
    smashBurger: {
      ...
      items: [
        { name: "سماش كلاسيك", nameEn: "Smash Classic", price: "145", description: "قطعة لحم بقري صافي + خس + طماطم + خيار مخلل + صوص جبنة" },
        { name: "دراجون هيل", nameEn: "Dragon Hill", price: "155", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + خيار مخلل + هالبينو + صوص سبايسي" },
        { name: "مشروم برجر", nameEn: "Mushroom Burger", price: "165", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + مشروم كريمي + خيار مخلل" },
        { name: "سكول أرت", nameEn: "School Art", price: "175", description: "قطعة لحم بقري صافي + خس + طماطم + بصل + بسطرمة + بيكون + سيدي صوص" },
        { name: "تريبل وي", nameEn: "Triple Way", price: "185", description: "قطعة لحم بقري صافي + خس + طماطم + بصل مكرمل + سيدي صوص" },
      ],
    },
    chickenWraps: {
      title: "منيو الفراخ",
      ...
      items: [
        {
          ...
          categories: [
            { name: "سنجل", nameEn: "Single", price: "125", description: "صدر فراخ مشوي قطع + بصل + فلفل ألوان + مشروم + بسطرمة + صوص أعشاب" },
            { name: "دبــل مع بطاطس", nameEn: "Double with Fries", price: "180", description: "صدر فراخ مشوي قطع + بصل + فلفل ألوان + مشروم + بسطرمة + صوص أعشاب + بطاطس" },
            { name: "تربل مع بطاطس", nameEn: "Triple with Fries", price: "220", description: "صدر فراخ مشوي قطع + بصل + فلفل ألوان + مشروم + بسطرمة + صوص أعشاب + بطاطس" },
          ],
        },
        {
          name: "كور راب تشيزكن",
          ...
          categories: [
            { name: "سنجل", nameEn: "Single", price: "120", description: "استربس مقلي + صوص اسبايسي + هالبينو + صوص جبنة" },
            { name: "دبــل مع بطاطس", nameEn: "Double with Fries", price: "175", description: "استربس مقلي + صوص اسبايسي + هالبينو + صوص جبنة + بطاطس" },
            { name: "تربل مع بطاطس", nameEn: "Triple with Fries", price: "215", description: "استربس مقلي + صوص اسبايسي + هالبينو + صوص جبنة + بطاطس" },
          ],
        },
        {
          name: "برجر راب رول",
          ...
          categories: [
            { name: "سنجل", nameEn: "Single", price: "149", description: "قطعة لحم بقري صافي + بصل + فلفل ألوان + مشروم + بسطرمة + سيدي صوص" },
            { name: "دبــل مع بطاطس", nameEn: "Double with Fries", price: "199", description: "قطعة لحم بقري صافي + بصل + فلفل ألوان + مشروم + بسطرمة + سيدي صوص + بطاطس" },
            { name: "تربل مع بطاطس", nameEn: "Triple with Fries", price: "239", description: "قطعة لحم بقري صافي + بصل + فلفل ألوان + مشروم + بسطرمة + سيدي صوص + بطاطس" },
          ],
        },
      ],
    },
